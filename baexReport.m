...
switch show
    ...
    case 4
        ...
        for k=3:-1:2
            ...
            mask = {{k, 1, [1 2 3 4 5 6], 3, 2, 2, 3, 2, 0, 2, 0, 1, 0, 0, 1} {k, 1, [4], 3, 2, 2, [3], 2, 0, [4], 0 , 0, 0, 0, 1}};
            config = expExpose(config, 't', 'step', 4, 'obs', [4 9 8], 'mask', mask, 'negativeRank', 4:6, 'precision', 2, 'save', 0, 'name', '+');
        end
end
